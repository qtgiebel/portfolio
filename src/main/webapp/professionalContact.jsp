    ...
    <body>
        ...
        <main>
            ...
            <form action="http://itins3.madisoncollege.edu/echo.php" id="commissionForm">
                ...
                <input type="text" name="getEmailCommission" id="getEmailCommission"
                    title="Enter a valid email address." pattern="^[\w\.\-]*@\w*\.\w*$" required>
                <br>
            ...
            <article>
                ...
                <p>Fill out this form with other professional inquiries. Please, allow up to 24 hours to receive a
                    reply.
                </p>
            </article>
