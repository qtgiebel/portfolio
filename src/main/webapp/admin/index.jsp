            ...
            <header class="col-2 bg-dark bg-gradient " id="categories-admin-view">
                    ...
                    <section class="container bg-secondary rounded-corners my-1 mt-2">
                        <div class="col">
                            ...
                            <main class="row row-cols-2">
                                ...
                                <div class="col py-2">
                                    <button class="img-thumbnail <c:if test="${verifiedUser.id ne visitorId}">new-dialog-btn</c:if>" data-dialogid="new-image-${category.id}-dialog">
                ...
                <div class="container py-1">
                    <section class="container bg-secondary rounded-corners my-1 mt-2">
                        <div class="col">
                            <header class="row">
                                <button class="btn btn-dark <c:if test="${verifiedUser.id ne visitorId}">new-dialog-btn</c:if>" data-dialogid="new-category-dialog">
                                    New Category
                                </button>
            ...
            <main class="col-10 max-height" id="piece-admin-view">
                ...
                <div class="navbar bg-light">
                    <div class="container">
                        ...
                        <div class="float-end">
                            <button id="archive-btn" class="btn btn-secondary <c:if test="${verifiedUser.id ne visitorId}">new-dialog-btn</c:if>" data-dialogid="archive-dialog" disabled>Archive</button>
                            ...
                            <button id="delete-btn" class="btn btn-danger <c:if test="${verifiedUser.id ne visitorId}">new-dialog-btn</c:if>" data-dialogid="delete-dialog" disabled>Delete</button>
